...
const SOURCE = {
  ...
  // Filtres — modal "Tous les filtres" + sheets distance/matière/barre
  filter_all:        'Tous',
  filter_pres:       'Présentiel',
  filter_vis:        'Visio',
  filter_all_title:  'Filtres',
  filter_niv_prim_s: 'Primaire',
  filter_niv_col_s:  'Collège',
  filter_niv_lyc_s:  'Lycée',
  filter_perimetre:  'Périmètre',
  filter_sort_by:    'Trier par',
  filter_recent:     'Récents',
  filter_reinit:     'Réinitialiser',
  filter_voir_cours: 'Voir les cours',
  filter_reset_filt: 'Réinitialiser les filtres',
  filter_dist_title: 'Distance',
  filter_dist_2km:   'Quartier',
  filter_dist_5km:   'Ville proche',
  filter_dist_10km:  'Zone urbaine',
  filter_dist_20km:  'Agglomération',
  filter_dist_50km:  'Grande région',
  filter_mat_title:  'Matière',
  filter_bar_title:  'Ma barre de filtres',
  filter_bar_sub:    'Appuie sur un filtre pour l\'ajouter ou le retirer',
  txt_oui:           'Oui',
  txt_non:           'Non',
